             ...
             <?php
                    ...
                    if ($error != null) {
                      echo "There is a problem ".$error;
                        ...
                        $sql = "insert into activity (SID, type, title, dateBegin, dateEnd, location, content) values('".$SID."', '".$type."', '".$title."', '".$begin."', '".$end."','".$location."', '".$content."')";

                        if(mysqli_query($connection,$sql) )
                        {
                            echo "<h4> Activity seccucefullly added! </h4>";
                        }
                        else
                        {
