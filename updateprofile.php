...
<?php
                    ...
                    if (isset($_POST['Save']))
                    {
                        ...
                        $sql = "UPDATE members SET   pass = '".$encrypted_pwd."', SID = '".$studentID."', firstName = '".$firstName."', lastName = '".$lastName."', phone = '".$phone."',  effatemail = '".$efemail."', personalEmail = '".$pemail."', graduationYear = '".$gyear."', college = '".$college."', department = '".$department."', about = '".$about."' WHERE SID = '".$currentSID."'";
